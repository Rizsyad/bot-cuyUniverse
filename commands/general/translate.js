...
module.exports = {
    ...
    aliases: ["trl"],
    category: "general",
    description: "Translate a text to another language (use c/translate list) to get all languange prefix",
    run: async(client, message, args) => {
        ...
        if(!args[0]){
            const ErrorEmbed = new MessageEmbed()
                .setTitle("Error")
                .setDescription("Harap masukkan bahasa atau gunakan (c/translate list) untuk mengetahui singkatan semua bahasa")
            ...
            .then(x => {
                const TranslateResult = x.text.charAt(0).toUpperCase() + x.text.slice(1).toLowerCase()
            ...
            const ErrorEmbed = new MessageEmbed()
                .setTitle("Error")
                .setDescription("Bahasa tidak di temukan atau gunakan (c/translate list) untuk mengetahui singkatan semua bahasa")
                .setColor(COLORS_EMBEED)
                .setFooter(client.user.username, client.user.displayAvatarURL())
                .setTimestamp();
